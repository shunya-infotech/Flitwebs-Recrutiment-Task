...
public class JwtTokenUtil implements Serializable {
  ...
  private String doGenerateToken(Authentication authentication) {
    ...
    return Jwts.builder()
        ...
        .setExpiration(
            new Date(
                System.currentTimeMillis() + JwtConstants.ACCESS_TOKEN_VALIDITY_SECONDS * 1000))
  ...
  public UsernamePasswordAuthenticationToken getAuthentication(
      final String token, final Authentication authentication, final UserDetails userDetails) {
